...
module.exports = function (RED) {
    ...
    function chartjsLineByd(config) {
        RED.nodes.createNode(this, config);

        var node = this;

        // load default template
        var template = fs.readFileSync(__dirname + '/templates/line-chart-byd.html', 'utf8');
    ...
    RED.nodes.registerType('chartjs-line-byd', chartjsLineByd);
};
